...
create table review (movie_id bigint not null, user_id varchar(255) not null, rating integer not null check (rating<=5 AND rating>=1), review_text varchar(255), primary key (movie_id, user_id));
